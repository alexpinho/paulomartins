    ...
    <Layout>
      <div className="home">
        <div className="home-hero">
           <motion.div initial={{opacity:0}} animate={{opacity:1}} transition={{duration: 1}} > <img src="images/banner-1.jpg" className="home-hero-banner col-xs-7" alt="" /></motion.div>
            <motion.div className="big-title-Book" initial={{opacity:0, translateX:-20}} animate={{opacity:1, translateX:0}} transition={{duration: 1}} >{t("hero-title-1")} <br/> 
